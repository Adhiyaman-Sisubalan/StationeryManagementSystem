...
namespace AD_Project.Controllers
{
...

    {
        ...
        public ActionResult SendOtp()
        {
            ...
            //Instead of Random Number You can pass User Id Here
        ...
        /*   public ActionResult ApproveKmt()
           {

               var dls = db.DisbursementLists.SqlQuery(
                   "SELECT [DisbursementListId],[DisbursementListDate],[DeptId],[Status]" +
                   "FROM[ADProject].[dbo].[DisbursementLists] " +
                   "ORDER BY [DisbursementListId]").LastOrDefault();
               dls.Status = "Approved";
               db.SaveChanges();
               return RedirectToAction("Catalogue");
           }

           public ActionResult RejectKmt()
           {
               var dls = db.DisbursementLists.SqlQuery(
                   "SELECT [DisbursementListId],[DisbursementListDate],[DeptId],[Status]" +
                   "FROM[ADProject].[dbo].[DisbursementLists] " +
